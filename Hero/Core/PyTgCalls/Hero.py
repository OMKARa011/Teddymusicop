    ...
    if int(assistant) == 1:
        try:
            ...
            return await mystic.edit(
                "Fᴀɪʟᴇᴅ ᴛᴏ ᴄʜᴀɴɢᴇ ᴠɪᴅᴇᴏ sᴛʀᴇᴀᴍ ᴘʟᴇᴀsᴇ sᴋɪᴘ ᴀɢᴀɪɴ..."
            )
    elif int(assistant) == 2:
        try:
            await pytgcalls2.change_stream(
            ...
            if str(finxx) == "raw":
                ...
                if int(quality) == 1080:
                    ...
                    if nrs == 0:
                        return await app.send_message(
                            chat_id,
                            "Fᴀɪʟᴇᴅ ᴛᴏ ғᴇᴛᴄʜ ᴠɪᴅᴇᴏ ғᴏʀᴍᴀᴛs ғᴏʀ ɴᴇxᴛ sᴛʀᴇᴀᴍ. ᴘʟᴇᴀsᴇ sᴋɪᴘ ᴛʜᴇ sᴛʀᴇᴀᴍ ᴛᴏ ʀᴇsᴜᴍᴇ ᴛʜᴇ ᴠᴏɪᴄᴇ ᴄʜᴀᴛ...",
                        )
                    try:
                        await pytgclients.change_stream(
                            chat_id,
                        ...
                        return await app.send_message(
                            chat_id,
                            "Sᴏᴍᴇ ᴇʀʀᴏʀ ᴏᴄᴄᴜʀᴇᴅ ᴡʜɪʟᴇ sᴡɪᴛᴄʜɪɴɢ ᴠɪᴅᴇᴏ sᴛʀᴇᴀᴍ... Pʟᴀʏᴏᴜᴛ ɪs ᴏɴ ʜᴏʟᴅ ɴᴏᴡ. ᴘʟᴇᴀsᴇ sᴋɪᴘ ᴛʜᴇ sᴛʀᴇᴀᴍ ᴛᴏ ʀᴇsᴜᴍᴇ ᴛʜᴇ ᴠᴏɪᴄᴇ ᴄʜᴀᴛ...",
                        )
                ...
                mystic = await app.send_message(
                    chat_id,
                    "**Pʟᴀʏʟɪsᴛ ғᴜɴᴄᴛɪᴏɴ... 📌**\n\n__Dᴏᴡɴʟᴏᴀᴅɪɴɢ ɴᴇxᴛ sᴏɴɢ/ᴍᴜsɪᴄ ғʀᴏᴍ ᴘʟᴀʏʟɪsᴛ... 🗂️__",
                )
                (
                    title,
                    duration_min,
